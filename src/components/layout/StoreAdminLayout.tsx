...
import { Columns2, Users, Boxes, ShoppingCart,LayoutDashboard, Monitor, BarChart3, Settings, Layers, Package, Settings2, Truck, ClipboardList, PlusCircle, History, User } from 'lucide-react';
...
const storeAdminMenu = [
    ...
    },
    {
        ...
        children: [
            ...
            { name: 'Opening Stock', icon: LayoutDashboard, path: '/store-admin/purchasing/opening-stock' },
        ]
    },
